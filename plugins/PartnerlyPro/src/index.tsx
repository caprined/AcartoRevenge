...
import { startRecording, stopRecording, getSessionAddedCount } from "./utils/recorder";
    ...
    component.then((instance: any) => {
      ...
      after("default", instance, (_args: any, res: any) => {
        try {
          ...
          if (children.some((b: any) => typeof b?.key === "string" && b.key.startsWith("partnerlypro"))) return;
          ...
          const openPanel = () => {
            showToast("Panel PartnerlyPro otwarty", getAssetIDByName("ic_apps_24px"));
          };

          const loadNew = () => {
            startRecording();
            showToast(`Load New aktywne — ${getSessionAddedCount()} wpisów`, getAssetIDByName("ic_refresh_24px"));
          };
